...
<body>
<header role="banner">
    <h1>ShoppitSmart Admin Panel</h1>
    <ul class="utilities">
        <br>
        <li class="logout warn"><a href="admin_registered_detail.php">View Admin Register Details</a></li>

 <li class="logout warn"><a href="admin_profile_update.php">Update Profile</a></li>
