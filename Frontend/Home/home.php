...
<a href="http://localhost/ECOMMERCE_WEBSITE_PROJECT/Frontend/shopping%20cart%20for%20ecom/project/project1_mobile.php">Order Now</a>
...
<div class="about_text">
    <h1><span>ShoppitSmart</span></h1>
    <h3>Why Choose us?</h3>
    <p>
        <b>At ShoppitSmart, we are committed to delivering an unparalleled shopping experience by offering a curated selection of high-quality products at competitive prices. Our focus on customer satisfaction, fast delivery, and exceptional service ensures that every purchase meets your expectations. Choose ShoppitSmart for convenience, value, and smart choices every time you shop!</b>
    </p>
</div>

</div>

<a href="http://localhost/ECOMMERCE_WEBSITE_PROJECT/Frontend/shopping%20cart%20for%20ecom/project/project1_mobile.php" class="about_btn">Order Now</a>


</div>
<div class="he">
<h1><center>ShoppitSmart </center></h1>
...
<div class="about_text">
    <h1><span>ShoppitSmart</span></h1>
    <h3><center>Smarter Facility, Better Savings</center></h3>
...
<div class="menu_card">
    ...
    <div class="menu_info">
        ...
        <a href="http://localhost/ECOMMERCE_WEBSITE_PROJECT/Frontend/shopping%20cart%20for%20ecom/project/project1_mobile.php" class="menu_btn">Order Now</a>
    </div>
...
<div class="menu_card">
    ...
    <div class="menu_info">
        <h2>ShoppitSmart</h2>
        <h3>
            Whirlpool 192 Litre 3 Star Direct<br> Cool Single Door Refrigerator
        </h3>
        <h3>₹25,0000.00</h3>
        <div class="menu_icon">
            <i class="fa-solid fa-star"></i>
...
<div class="menu_card">
    ...
    <div class="menu_info">
        <h2>ShoppitSmart</h2>
        <h3>
            ASUS VivoBook Pro 15 <br>OLED Ultra Slim Laptop                    </h3>
        <h3>₹80,000.00</h3>
        <div class="menu_icon">
            <i class="fa-solid fa-star"></i>
            <i class="fa-solid fa-star"></i>
...
<div class="menu_card">
    ...
    <div class="menu_info">
        <h2>ShoppitSmart</h2>
        <h3>
            Samsung Galaxy Tab S10 <br>Ultra Platinum Silver 3D                    </h3>
        <h3>₹15,000.00</h3>
        <div class="menu_icon">
            <i class="fa-solid fa-star"></i>
            <i class="fa-solid fa-star"></i>
...
<div class="menu_card">
    ...
    <div class="menu_info">
        <h2>ShoppitSmart</h2>
        <h3>
            LG 11 kg FHP1411Z9B Washing Machine                    </h3>
        <h3>₹50,000.00</h3>
        <div class="menu_icon">
            <i class="fa-solid fa-star"></i>
            <i class="fa-solid fa-star"></i>
...
<div class="menu_card">
    ...
    <div class="menu_info">
        <h2>ShoppitSmart</h2>
        <h3>
            Amazon Fire TV Stick 4K <br>Max streaming device                    </h3>
        <h3>₹2,000.00</h3>
        <div class="menu_icon">
            <i class="fa-solid fa-star"></i>
            <i class="fa-solid fa-star"></i>
...
<div class="menu_card">
    ...
    <div class="menu_info">
        <h2>ShoppitSmart</h2>
        <h3>
            Hitachi 1 Ton 3 Star Inverter <br>Split AC (RAFS312HEEA)
        </h3>
        <h3>₹29,990.00</h3>
        <div class="menu_icon">
            <i class="fa-solid fa-star"></i>
